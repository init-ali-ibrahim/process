...
//   final Flavor initialFlavor;
//   final Colour initialColour;
//
...
//       imagePath: 'assets/cakes/${initialShape.name.toLowerCase()}_${initialFlavor.name.toLowerCase()}_${initialColour.name.toLowerCase()}.png',
...
//   DoneCustomizationScreen(
//       {super.key, required this.Shape, required this.Flavor, required this.Colour});
//
//   final Shape Shape;
//   final String Flavor;
//   final String Colour;
